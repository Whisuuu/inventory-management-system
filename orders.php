					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="form-control" name="paymentPlace" id="paymentPlace">
								...
								<option value="4">Sihanoukville</option>
								<option value="5">Kampot</option>
								<option value="6">Kep</option>
								<option value="7">Kandal</option>
								<option value="8">Koh Kong</option>
								<option value="9">Pailin</option>
								<option value="10">Preah Vihear</option>
								<option value="11">Kampong Cham</option>
								<option value="12">Kampong Speu</option>
								<option value="13">Kampong Thom</option>
								<option value="14">Banteay Meanchey</option>
								<option value="15">Takeo</option>
								<option value="16">Svay Rieng</option>
								<option value="17">Pursat</option>
								<option value="18">Oddar Meanchey</option>
								<option value="19">Mondulkiri</option>
								<option value="20">Ratanakiri</option>
								<option value="21">Stung Treng</option>
								<option value="22">Prey Veng</option>
								<option value="23">Tboung Khmum</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="form-control" name="paymentPlace" id="paymentPlace">
								...
								<option value="12" <?php if ($data[13] == 12) {
														echo "selected";
													} ?>>Kampong Speu</option>
								<option value="13" <?php if ($data[13] == 13) {
														echo "selected";
													} ?>>Kampong Thom</option>
								<option value="14" <?php if ($data[13] == 14) {
														echo "selected";
													} ?>>Banteay Meanchey</option>
								<option value="15" <?php if ($data[13] == 15) {
														echo "selected";
													} ?>>Takeo</option>
								<option value="16" <?php if ($data[13] == 16) {
														echo "selected";
													} ?>>Svay Rieng</option>
								<option value="17" <?php if ($data[13] == 17) {
														echo "selected";
													} ?>>Pursat</option>
								<option value="18" <?php if ($data[13] == 18) {
														echo "selected";
													} ?>>Oddar Meanchey</option>
								<option value="19" <?php if ($data[13] == 19) {
														echo "selected";
													} ?>>Mondulkiri</option>
								<option value="20" <?php if ($data[13] == 20) {
														echo "selected";
													} ?>>Ratanakiri</option>
								<option value="21" <?php if ($data[13] == 21) {
														echo "selected";
													} ?>>Stung Treng</option>
								<option value="22" <?php if ($data[13] == 22) {
														echo "selected";
													} ?>>Prey Veng</option>
								<option value="23" <?php if ($data[13] == 23) {
														echo "selected";
													} ?>>Tboung Khmum</option>
							</select>
